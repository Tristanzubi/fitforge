...
export function BottomNav({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-50 border-t border-app-edge bg-app-card/95 backdrop-blur-md" style={{ paddingBottom: "env(safe-area-inset-bottom, 0px)" }}>
      <div className="flex items-stretch">
          ...
          return (
            <Link
              ...
              className={`flex flex-1 flex-col items-center gap-0.5 py-2 text-[9px] font-medium transition-colors ${
                isActive ? "text-orange-400" : "text-app-fg3 hover:text-app-fg1"
              }`}
            >
        ...
        <button
          ...
          className={`flex flex-1 flex-col items-center gap-0.5 py-2 text-[9px] font-medium transition-colors ${
            chatOpen ? "text-orange-400" : "text-app-fg3 hover:text-app-fg1"
          }`}
        >
